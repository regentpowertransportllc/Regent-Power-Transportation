...
Protoplus.ui = {
    ...
    spinner: function(element, options){
        ...
        arrowCont.insert(upTD = new Element('div', {className: 'form-spinner-button form-spinner-up'}).insert(upArrow = new Element('img', {src:options.iconPath, alt:'up arrow'})));
        // Construct the down arrow
        arrowCont.insert(downTD = new Element('div', {className: 'form-spinner-button form-spinner-down'}).insert(downArrow = new Element('img', {src:options.iconPath, style:'transform: rotate(180deg);', alt:'down arrow'})));
